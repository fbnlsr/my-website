...
{% blogimg date | blogdate, "color-infos.png", "Color Info" %}
...
{% blogimg date | blogdate, "git-blame.gif", "Git Blame" %}
...
{% blogimg date | blogdate, "todo-highlight.png", "Todo Highlight" %}
...
{% blogimg date | blogdate, "bookmarks.png", "Bookmarks" %}
...
{% blogimg date | blogdate, "cdnjs.gif", "cdnjs" %}
